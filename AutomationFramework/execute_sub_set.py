...
if __name__ == '__main__':
    ...
    parser.add_argument("tests_sub_set", help="The sub set of tests to execute. It can be a block or a sub-block. i.e. "
                                              "tests/hardware or tests/hardware/test_hw_component.py")
    ...
    if len(split_sub_set) == 2:
        ...
        raise Exception('Not allowed sub set. Expected notation: tests/hardware or tests/hardware/test_hw_component.py')
