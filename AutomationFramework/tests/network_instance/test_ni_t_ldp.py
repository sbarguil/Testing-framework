...
class TestNetworkInstanceTLDP(BaseTest):
    ...
    @pytest.mark.skip(reason="Incomplete template, error: ncclient.operations.rpc.RPCError: /network-instances/network-instance[name='Prueba_LxVPN']/mpls: the 'when' expression './config/type = 'oc-ni-types:DEFAULT_INSTANCE''' failed")
